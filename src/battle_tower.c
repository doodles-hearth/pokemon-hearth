...
const struct FacilityClass gTowerMaleFacilityClasses[FACILITY_CLASSES_MALE] =
{
    ...
    {FACILITY_CLASS_COOLTRAINER_M, OBJ_EVENT_GFX_SUNRISE_MAN_1},
    ...
    {FACILITY_CLASS_GUITARIST, OBJ_EVENT_GFX_SUNRISE_MAN_1},
    {FACILITY_CLASS_KINDLER, OBJ_EVENT_GFX_SUNRISE_MAN_1},
    ...
    {FACILITY_CLASS_DRAGON_TAMER, OBJ_EVENT_GFX_SUNRISE_MAN_2},
    {FACILITY_CLASS_BIRD_KEEPER, OBJ_EVENT_GFX_SUNRISE_MAN_2},
    ...
    {FACILITY_CLASS_PKMN_BREEDER_M, OBJ_EVENT_GFX_SUNRISE_MAN_1},
...
{
    {FACILITY_CLASS_AROMA_LADY, OBJ_EVENT_GFX_SUNRISE_WOMAN_2},
    {FACILITY_CLASS_TUBER_F, OBJ_EVENT_GFX_TUBER_F},
    {FACILITY_CLASS_COOLTRAINER_F, OBJ_EVENT_GFX_SUNRISE_WOMAN_1},
    {FACILITY_CLASS_HEX_MANIAC, OBJ_EVENT_GFX_HEX_MANIAC},
    {FACILITY_CLASS_LADY, OBJ_EVENT_GFX_SUNRISE_WOMAN_2},
    {FACILITY_CLASS_BEAUTY, OBJ_EVENT_GFX_BEAUTY},
    {FACILITY_CLASS_PSYCHIC_F, OBJ_EVENT_GFX_LASS},
    {FACILITY_CLASS_SCHOOL_KID_F, OBJ_EVENT_GFX_SUNRISE_GIRL_2},
    ...
    {FACILITY_CLASS_BATTLE_GIRL, OBJ_EVENT_GFX_SUNRISE_GIRL_2},
    {FACILITY_CLASS_PARASOL_LADY, OBJ_EVENT_GFX_SUNRISE_WOMAN_1},
    {FACILITY_CLASS_SWIMMER_F, OBJ_EVENT_GFX_RUNNING_TRIATHLETE_F},
    {FACILITY_CLASS_PICNICKER, OBJ_EVENT_GFX_PICNICKER},
    {FACILITY_CLASS_PKMN_BREEDER_F, OBJ_EVENT_GFX_SUNRISE_WOMAN_2},
