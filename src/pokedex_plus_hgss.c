...
static void HandleTargetSpeciesPrintText(u32 targetSpecies, u32 base_x, u32 base_y, u32 base_y_offset, u32 base_i)
{
    ...
    u32 fontId = GetSpeciesNameFontId(GetSpeciesNameWidthInChars(GetSpeciesName(targetSpecies, DO_NAME_CHECK)));
...
static void PrintEvolutionTargetSpeciesAndMethod(u8 taskId, u16 species, u8 depth, u32 *depth_i, u32 alreadyPrintedIcons[], u32 *icon_depth_i, u32 numLines)
{
    ...
    for (i = 0; i < times; i++)
    {
        ...
        u32 speciesNameWidthInChars = GetSpeciesNameWidthInChars(GetSpeciesName(targetSpecies, DO_NAME_CHECK));
        ...
        case EVO_SPLIT_FROM_EVO:
            ...
            StringAppend(gStringVar4, GetSpeciesName(evolutions[i].param, DO_NAME_CHECK)); //mon name
            break;
        case EVO_BATTLE_END:
        ...
        for (j = 0; evolutions[i].params != NULL && evolutions[i].params[j].condition != CONDITIONS_END; j++)
        {
            ...
            case IF_TIME:
                ...
                case TIME_LUNCHTIME:     StringAppend(gStringVar4, COMPOUND_STRING("Day"));     break;
            ...
            case IF_NOT_TIME:
                ...
                case TIME_LUNCHTIME:     StringAppend(gStringVar4, COMPOUND_STRING("NOT Day"));     break;
            ...
            case IF_SPECIES_IN_PARTY:
                StringAppend(gStringVar4, GetSpeciesName(evolutions[i].params[j].arg1, SKIP_NAME_CHECK)); //mon name
            ...
            case IF_TRADE_PARTNER_SPECIES:
                ...
                StringAppend(gStringVar4, GetSpeciesName(evolutions[i].params[j].arg1, DO_NAME_CHECK));
                break;
            // Gen 6
