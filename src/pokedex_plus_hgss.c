...
static void PrintStatsScreen_NameGender(u8 taskId, u32 num, u32 value)
{
    ...
    //Name
    const u8 *name = GetSpeciesName(species, DO_NAME_CHECK);
    ...
    for (i = 0; i < times; i++)
    {
        ...
        else
        {
            ...
            case EVO_SPLIT_FROM_EVO:
                ...
                StringAppend(gStringVar4, GetSpeciesName(evolutions[i].param, SKIP_NAME_CHECK)); //mon name
                break;
            case EVO_BATTLE_END:
            ...
            for (u32 j = 0; evolutions[i].params != NULL && evolutions[i].params[j].condition != CONDITIONS_END; j++)
            {
                ...
                case IF_TRADE_PARTNER_SPECIES:
                    ...
                    StringAppend(gStringVar4, GetSpeciesName(evolutions[i].params[j].arg1, SKIP_NAME_CHECK));
                    break;
                // Gen 6
