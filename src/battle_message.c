...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_SMOKEEXPLOSION]                       = COMPOUND_STRING("The smoke explodes!"), 
    ...
    [STRINGID_PKMNSAPPEDBYDECAY]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s health is sapped by the Decay!"),
    ...
    [STRINGID_PKMNISDREAMING]                       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is deep in a dream."),
    ...
    [STRINGID_ENEMYABOUTTOSWITCHPKMN]               = COMPOUND_STRING("{B_TRAINER1_NAME_WITH_CLASS} is about to send out\n{B_BUFF2}.\pWill you switch your Pokémon?"),
    ...
    [STRINGID_PKMNISALONE]                          = COMPOUND_STRING("You're all alone right now.{PAUSE 64}"),
    ...
    [STRINGID_RUINABILITYHPGAIN]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY} healed it a little bit!"), // Not in Gen 5+
    ...
    [STRINGID_BELCHCANTSELECT]                      = COMPOUND_STRING("Your Pokémon can't use this move because it hasn't eaten any Berries!\p"),
    ...
    [STRINGID_ARAINBOWAPPEAREDONSIDE]               = COMPOUND_STRING("A rainbow appeared in the sky on {B_ATK_TEAM2} side!"),
    ...
    [STRINGID_SEAOFFIREENVELOPEDSIDE]               = COMPOUND_STRING("A sea of fire enveloped {B_DEF_TEAM2} side!"),
    ...
    [STRINGID_SWAMPENVELOPEDSIDE]                   = COMPOUND_STRING("A swamp enveloped {B_DEF_TEAM2} side!"),
    ...
    [STRINGID_DECAYSPREADS]                         = COMPOUND_STRING("Decay spreads everywhere."),
    [STRINGID_DECAYWASCLEANSED]                     = COMPOUND_STRING("The decay was cleansed."),
    ...
    [STRINGID_SMOKEEXPLOSIONINEFFECTIVE]            = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY} made the explosion ineffective!"), //not in gen 5+, ability popup
...
const u16 gMoveWeatherChangeStringIds[] =
{
    ...
    [B_MSG_STARTED_DECAY]     = STRINGID_DECAYSPREADS,
};
...
const u16 gWeatherEndsStringIds[B_MSG_WEATHER_END_COUNT] =
{
    ...
    [B_MSG_WEATHER_END_DECAY]                      = STRINGID_DECAYWASCLEANSED,
};
...
const u16 gWeatherTurnStringIds[] =
{
    ...
    [B_MSG_WEATHER_TURN_DECAY]        = STRINGID_DECAYSPREADS,
};
...
const u16 gSandStormHailDmgStringIds[] =
{
    ...
    [B_MSG_DECAY]     = STRINGID_PKMNSAPPEDBYDECAY
};
...
const u16 gWeatherStartsStringIds[] =
{
    ...
    [WEATHER_DECAY]              = STRINGID_DECAYSPREADS,
};
...
const u16 gFlashFireStringIds[] =
{
    ...
    [B_MSG_FLASH_FIRE_NO_BOOST_SMOKE] = STRINGID_SMOKEEXPLOSIONINEFFECTIVE,
};
