...
static const SpotImage32 sGyaradosTokuanSpotImages[4] = {
    INCGFX_U32("graphics/pokemon/gyarados/tokuan/spots/spot_0.png", ".1bpp", "-plain -data_width 4"),
    INCGFX_U32("graphics/pokemon/gyarados/tokuan/spots/spot_1.png", ".1bpp", "-plain -data_width 4"),
    INCGFX_U32("graphics/pokemon/gyarados/tokuan/spots/spot_2.png", ".1bpp", "-plain -data_width 4"),
    INCGFX_U32("graphics/pokemon/gyarados/tokuan/spots/spot_3.png", ".1bpp", "-plain -data_width 4"),
};
static const struct MonSpot sGyaradosTokuanSpots[4] = {
    {.x = 26, .y = 26, .image = sGyaradosTokuanSpotImages[3]},
    {.x = 54, .y = 40, .image = sGyaradosTokuanSpotImages[2]},
    {.x = 32, .y = 8, .image = sGyaradosTokuanSpotImages[1]},
    {.x = 16, .y = 32, .image = sGyaradosTokuanSpotImages[0]},
};
const struct MonSpotTemplate gGyaradosTokuanSpotTemplate = {
    .spots = sGyaradosTokuanSpots,
    .count = ARRAY_COUNT(sGyaradosTokuanSpots),
    .scale = SCALE_4,
    .xOffsetFrame2 = 4,
    .yOffsetFrame2 = 8,
    .firstColor = 1,
...
static const struct MonSpotTemplate* GetSpeciesSpots(enum Species species)
{
    ...
    case SPECIES_MAGIKARP_TOKUAN:
    case SPECIES_GYARADOS_TOKUAN:
            return &gGyaradosTokuanSpotTemplate;
    default:
        return NULL;
    }
}
