...
static const u8 sTileBitAttributes[NUM_METATILE_BEHAVIORS] =
{
    ...
    [MB_DECAY]                           = TILE_FLAG_UNUSED,
    [MB_TEAPOT]                          = TILE_FLAG_UNUSED,
    ...
    [MB_CLOSED_TOKU_DOOR]                   = TILE_FLAG_UNUSED,
};
...
bool8 MetatileBehavior_IsCave(u8 metatileBehavior)
{
...
bool8 Unref_MetatileBehavior_IsGong(u8 metatileBehavior)
{
    return metatileBehavior == MB_GONG;
}
...
bool8 Unref_MetatileBehavior_IsTeapot(u8 metatileBehavior)
{
    return metatileBehavior == MB_TEAPOT;
}
...
bool8 MetatileBehavior_IsClosedTokuDoor(u8 metatileBehavior)
{
    if (metatileBehavior == MB_CLOSED_TOKU_DOOR)
        return TRUE;
    else
        return FALSE;
}
