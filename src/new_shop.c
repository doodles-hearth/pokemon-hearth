...
static const struct Seller sSellers[] = {
    [SELLER_MART_FEMALE] = {
        ...
        // First seller's message is also used as default value for other sellers
        // with missing message attribute: do not remove this
        .message = {
            [SELLER_MSG_RETURN_TO_FIELD]   = COMPOUND_STRING("{CREATE_MUGSHOT MUGSHOT_CLERK EMOTE_NORMAL}{SPEAKER NAME_SHOPKEEPER}Anything else I can help you with?"),
    ...
    [SELLER_ZUBAT] = {
        ...
        .message = {
            [SELLER_MSG_RETURN_TO_FIELD]   = COMPOUND_STRING("{CREATE_MUGSHOT MUGSHOT_ZUBAT EMOTE_NORMAL}{SPEAKER NAME_ZUBAT_GRUNT}Got thee more money to spend?"),
    ...
    [SELLER_INCENSE] = {
        ...
        .message = {
            [SELLER_MSG_RETURN_TO_FIELD]   = COMPOUND_STRING("{CREATE_MUGSHOT MUGSHOT_INCENSE EMOTE_NORMAL}{SPEAKER NAME_SHOPKEEPER}Yawn… Anything else?"),
            [SELLER_MSG_BUY_PROMPT]        = COMPOUND_STRING("{STR_VAR_1}?\nSure, uh…\n¥{STR_VAR_2}…"),
