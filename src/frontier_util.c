...
void SetBattleFacilityTrainerGfxId(u16 trainerId, u8 tempVarId)
{
    ...
    case 0:
    default:
        VarSet(VAR_OBJ_GFX_ID_0, OBJ_EVENT_GFX_UUME_BOY_1);
        return;
    case 1:
        VarSet(VAR_OBJ_GFX_ID_1, OBJ_EVENT_GFX_UUME_BOY_1);
        return;
    case 15:
        VarSet(VAR_OBJ_GFX_ID_E, OBJ_EVENT_GFX_UUME_BOY_1);
        return;
    }
}
...
u16 GetBattleFacilityTrainerGfxId(u16 trainerId)
{
    ...
    {
        return OBJ_EVENT_GFX_UUME_BOY_1;
    }
}
...
static void PrintBannedSpeciesName(u8 windowId, u32 itemId, u8 y)
{
    ...
    AddTextPrinterParameterized4(windowId,
                                 ...
                                 GetSpeciesName(list[itemId], SKIP_NAME_CHECK));
}
