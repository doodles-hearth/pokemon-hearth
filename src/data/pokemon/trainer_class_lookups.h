const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_LEADER_ROXANNE] = TRAINER_PIC_FRONT_LEADER_KOISHI,
    [FACILITY_CLASS_LEADER_BRAWLY] = TRAINER_PIC_FRONT_LEADER_HANA,
...
const enum TrainerClassID gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_LEADER_ROXANNE] = TRAINER_CLASS_DOJO_MASTER,
    [FACILITY_CLASS_LEADER_BRAWLY] = TRAINER_CLASS_DOJO_MASTER,
    [FACILITY_CLASS_LEADER_TATE_AND_LIZA] = TRAINER_CLASS_DOJO_MASTER,
