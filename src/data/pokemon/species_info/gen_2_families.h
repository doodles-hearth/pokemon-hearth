...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_BONSLY] =
    {
        ...
        .evolutions = EVOLUTION(
            {EVO_LEVEL, 0, SPECIES_SUDOWOODO, CONDITIONS({IF_KNOWS_MOVE, MOVE_MIMIC})},
            {EVO_LEVEL, 0, SPECIES_HONESTREE, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD}, {IF_KNOWS_MOVE_TYPE, TYPE_GRASS})}
        ),
    },
#endif //P_GEN_4_CROSS_EVOS
