...
[SPECIES_SEWADDLE_TOKUAN] =
    {
        ...
        .cryId = CRY_SEWADDLE,
        .natDexNum = NATIONAL_DEX_SEWADDLE_TOKUAN,
        .categoryName = _("Sewing"),
        .height = 3,
        .weight = 25,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_SWADLOON_TOKUAN] =
    {
        ...
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Swadloon"),
        .unknownName = _("Leaf Wrap"),
        .cryId = CRY_SWADLOON,
        .natDexNum = NATIONAL_DEX_SWADLOON_TOKUAN,
        .categoryName = _("Leaf-Wrapped"),
        .height = 5,
        .weight = 73,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_LEAVANNY_TOKUAN] =
    {
        ...
        .cryId = CRY_LEAVANNY,
        .natDexNum = NATIONAL_DEX_LEAVANNY_TOKUAN,
        .categoryName = _("Nurturing"),
        .height = 12,
        .weight = 205,
        .description = COMPOUND_STRING(
