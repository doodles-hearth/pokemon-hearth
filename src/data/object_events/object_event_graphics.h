...
const u32 gObjectEventPic_BattleGirl[] = INCBIN_U32("graphics/object_events/pics/people/martial_artist_f.4bpp");
const u16 gObjectEventPal_BattleGirl[] = INCBIN_U16("graphics/object_events/palettes/martial_artist_f.gbapal");
