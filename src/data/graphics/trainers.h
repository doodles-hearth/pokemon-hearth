...
const struct SpriteFrameImage gTrainerBackPicTable_Samurai[] =
{
    {gTrainerBackPic_Samurai + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Samurai + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Samurai + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Samurai + TRAINER_PIC_SIZE * 3, TRAINER_PIC_SIZE},
};
...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_SAMURAI, 4, gTrainerBackPic_Samurai, gTrainerBackPicTable_Samurai, gTrainerPalette_Samurai, sBackAnims_Hoenn),
};
