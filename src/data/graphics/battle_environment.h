...
const u32 gBattleEnvironmentTiles_GinkoWoods[] = INCGFX_U32("graphics/battle_environment/ginko_forest/tiles.png", ".4bpp.smol");
const u16 gBattleEnvironmentPalette_GinkoWoods[] = INCGFX_U16("graphics/battle_environment/ginko_forest/palette.pal", ".gbapal");
const u32 gBattleEnvironmentTilemap_GinkoWoods[] = INCBIN_U32("graphics/battle_environment/ginko_forest/map.bin.smolTM");

const u32 gBattleEnvironmentTiles_Plains[] = INCGFX_U32("graphics/battle_environment/plains/tiles.png", ".4bpp.smol");
const u16 gBattleEnvironmentPalette_Plains[] = INCGFX_U16("graphics/battle_environment/plains/palette.pal", ".gbapal");
const u32 gBattleEnvironmentTilemap_Plains[] = INCBIN_U32("graphics/battle_environment/plains/map.bin.smolTM");

const u32 gBattleEnvironmentTiles_TallGrassBlue[] = INCGFX_U32("graphics/battle_environment/tall_grass_blue/tiles.png", ".4bpp.smol");
const u16 gBattleEnvironmentPalette_TallGrassBlue[] = INCGFX_U16("graphics/battle_environment/tall_grass_blue/palette.pal", ".gbapal");
const u32 gBattleEnvironmentTilemap_TallGrassBlue[] = INCBIN_U32("graphics/battle_environment/tall_grass_blue/map.bin.smolTM");

const u32 gBattleEnvironmentAnimTiles_TallGrassBlue[] = INCGFX_U32("graphics/battle_environment/tall_grass_blue/anim_tiles.png", ".4bpp.smol");
const u32 gBattleEnvironmentAnimTilemap_TallGrassBlue[] = INCBIN_U32("graphics/battle_environment/tall_grass_blue/anim_map.bin.smolTM");

const u32 gBattleEnvironmentAnimTiles_GinkoWoods[] = INCGFX_U32("graphics/battle_environment/ginko_forest/anim_tiles.png", ".4bpp.smol");
...
const u32 gBattleEnvironmentAnimTiles_Plains[] = INCGFX_U32("graphics/battle_environment/plains/anim_tiles.png", ".4bpp.smol");
