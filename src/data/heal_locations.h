static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_MAGURO_HARBOR - 1] = {MAP_GROUP(MAGURO_HARBOR), MAP_NUM(MAGURO_HARBOR), 19, 12},
    ...
    [HEAL_LOCATION_SOULKEEP - 1] = {MAP_GROUP(SOULKEEP), MAP_NUM(SOULKEEP), 19, 25},
    [HEAL_LOCATION_SUNRISE_VILLAGE - 1] = {MAP_GROUP(SUNRISE_VILLAGE), MAP_NUM(SUNRISE_VILLAGE), 13, 13},
    [HEAL_LOCATION_SABERSIDE_TOWN - 1] = {MAP_GROUP(SABERSIDE_TOWN), MAP_NUM(SABERSIDE_TOWN), 12, 12},
    [HEAL_LOCATION_COREEF_ISLE - 1] = {MAP_GROUP(COREEF_ISLE), MAP_NUM(COREEF_ISLE), 15, 14},
    [HEAL_LOCATION_HAVEN_ISLE - 1] = {MAP_GROUP(HAVEN_ISLE), MAP_NUM(HAVEN_ISLE), 31, 36},
    [HEAL_LOCATION_MIDDLE_ISLE - 1] = {MAP_GROUP(MIDDLE_ISLE), MAP_NUM(MIDDLE_ISLE), 15, 15},
    [HEAL_LOCATION_TOP_ISLE - 1] = {MAP_GROUP(TOP_ISLE), MAP_NUM(TOP_ISLE), 20, 20},
    [HEAL_LOCATION_HANABI_CITY - 1] = {MAP_GROUP(HANABI_CITY), MAP_NUM(HANABI_CITY), 25, 20},
    [HEAL_LOCATION_DRYUGON - 1] = {MAP_GROUP(DRYUGON), MAP_NUM(DRYUGON), 15, 15},
    [HEAL_LOCATION_SHOGUNATE - 1] = {MAP_GROUP(SHOGUNATE), MAP_NUM(SHOGUNATE), 15, 15},
    [HEAL_LOCATION_WINDY_CAPE2 - 1] = {MAP_GROUP(WINDY_CAPE2), MAP_NUM(WINDY_CAPE2), 32, 55},
    [HEAL_LOCATION_YIFU_CITY - 1] = {MAP_GROUP(YIFU_CITY), MAP_NUM(YIFU_CITY), 32, 30},
};
