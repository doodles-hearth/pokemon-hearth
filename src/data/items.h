...
// Medicine
    ...
    {
        .name = ITEM_NAME("Sacred Ointment"),
        .price = 2000,
        .holdEffectParam = 255,
        .description = COMPOUND_STRING(
            "Out of battle,\n"
    ...
    #if I_ITEM_PRICES_HEARTH
        .price = 50,
    #elif (I_PRICE >= GEN_8 || I_PRICE == GEN_1)
        .price = 200,
    #elif I_PRICE == GEN_7
        .price = 100,
    #else
...
// Story Key Items
    ...
    [ITEM_ASHIIS_SCARF] =
    {
        .name = ITEM_NAME("Ashii's Scarf"),
        .pluralName = ITEM_NAME("Ashii's Scarves"),
        .price = 0,
        .description = COMPOUND_STRING(
            "A soft silk scarf,\n"
            "proof of a girl's\n"
...
// GEN 9 ITEMS
    ...
    {
        .name = ITEM_NAME("Entei Statuette"),
        .price = 0,
        .description = COMPOUND_STRING(
            "A statuette made\n"
            "from volcanic rock.\n"
