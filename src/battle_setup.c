...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_CINDY] = REMATCH(TRAINER_HIINA, TRAINER_CINDY_3, TRAINER_CINDY_4, TRAINER_CINDY_5, TRAINER_CINDY_6, ROUTE104),
    ...
    [REMATCH_CALVIN] = REMATCH(TRAINER_TOSHIO_1, TRAINER_CALVIN_2, TRAINER_CALVIN_3, TRAINER_CALVIN_4, TRAINER_CALVIN_5, ROUTE102),
    ...
    [REMATCH_CYNDY] = REMATCH(TRAINER_MAKOTO_1, TRAINER_CYNDY_2, TRAINER_CYNDY_3, TRAINER_CYNDY_4, TRAINER_CYNDY_5, ROUTE115),
    ...
    [REMATCH_HALEY] = REMATCH(TRAINER_MUSASHI_1, TRAINER_HALEY_2, TRAINER_HALEY_3, TRAINER_HALEY_4, TRAINER_HALEY_5, ROUTE104),
    [REMATCH_JAMES] = REMATCH(TRAINER_TSUYA, TRAINER_JAMES_2, TRAINER_JAMES_3, TRAINER_JAMES_4, TRAINER_JAMES_5, PETALBURG_WOODS),
...
{
    if (TRAINER_BATTLE_PARAM.objEventLocalIdA == TRAINER_BATTLE_NO_WHITEOUT_CONTINUE_SCRIPT || 
        TRAINER_BATTLE_PARAM.mode == TRAINER_BATTLE_NO_INTRO_NO_WHITEOUT)
        return TRUE;
    else
        return FALSE;
}
