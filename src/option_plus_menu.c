...
static void DrawRightSideChoiceText(const u8 *str, int x, int y, bool8 selected, bool8 active);
...
#define TEXT_COLOR_OPTIONS_ORANGE_SHADOW 5
#define TEXT_COLOR_OPTIONS_ORANGE_FG 6
...
static const u8 *const sOptionMenuItemsNamesMain[MENUITEM_MAIN_COUNT] =
    {
        [MENUITEM_MAIN_TEXTSPEED] = COMPOUND_STRING("Text speed"),
        ...
        [MENUITEM_MAIN_CANCEL] = COMPOUND_STRING("Cancel"),
};
...
static bool8 CheckConditions(int selection)
{
    ...
    default:
        ...
        case MENUITEM_MAIN_TEXTSPEED:
            return TRUE;
        case MENUITEM_MAIN_BATTLESPEED:
            return TRUE;
...
static const u8 sText_Desc_BattleSpeed[] = _("Choose one of the three battle\nanimation speeds.");
...
static const u8 *const OptionTextDescription(void)
{
    ...
    default:
        ...
        if (
            menuItem == MENUITEM_MAIN_TEXTSPEED
            || menuItem == MENUITEM_MAIN_BATTLESPEED
            || menuItem == MENUITEM_MAIN_FRAMETYPE
        )
            selection = 0;
...
static const u8 sText_TopBar_Main[] = _("Settings");
...
static void DrawRightSideChoiceText(const u8 *text, int x, int y, bool8 selected, bool8 active)
{
    u8 color_red[3];
    u8 color_gray[3];
