...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("Aka");
const u8 gText_ExpandedPlaceholder_May[] = _("Ao");
...
const u8 gText_DefaultNameAka[] = _("Aka");
const u8 gText_DefaultNameAo[] = _("Ao");
...
const u8 gText_PokedexRegistration[] = _("Updated the PokéDex!");
...
const u8 gText_SelectorArrow[] = _("{COLOR RED}▶{COLOR DARK_GRAY}");
...
const u8 gText_SelectorArrow2[] = _("{COLOR RED}▶{COLOR DARK_GRAY}");
...
const u8 gText_ScrollsCantBeHeld[] = _("Scrolls can't be held.");
...
const u8 gText_DadsAdvice[] = _("Big Sis's advice…\n{PLAYER}, there's a time and place for\leverything!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Price[] = _("PRICE");
const u8 gText_InBag[] = _("IN BAG");
const u8 gText_ReturnToField[] = _("Return to Field");
...
const u8 gText_MailSentToPC[] = _("The Mail was sent to your chest.{PAUSE_UNTIL_PRESS}");
const u8 gText_PCMailboxFull[] = _("Your mailbox is full.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_EggFromHotSprings[] = _("A Pokémon Egg given by\na Shamisen Player.");
...
const u8 gText_ReturnDecorationToPC[] = _("Put this decoration back in the chest?");
const u8 gText_DecorationReturnedToPC[] = _("The decoration was put back in\nthe chest.");
...
const u8 gText_TMs_Hms[] = _("Techniques");
...
const u8 gText_Bro[] = _("bro");
const u8 gText_Sis[] = _("sis");
const u8 gText_Brother[] = _("brother");
const u8 gText_Sister[] = _("sister");
const u8 gText_Mr[] = _("Mister");
const u8 gText_Mrs[] = _("Missus");
...
const u8 gText_Guy[] = _("guy");
const u8 gText_Gal[] = _("gal");
...
const u8 gText_SelectorArrow3[] = _("{COLOR RED}▶{COLOR DARK_GRAY}");
...
const u8 gText_BoxName[] = _("Pen name?");
