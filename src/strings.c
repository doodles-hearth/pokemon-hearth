...
const u8 gText_ReturnDecorationToPC[] = _("Return this decoration to the chest?");
const u8 gText_DecorationReturnedToPC[] = _("The decoration was returned to the chest.");
