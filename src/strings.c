...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("Archie");
...
const u8 gText_DefaultNameAka[] = _("Archie");
...
const u8 gText_DadsAdvice[] = _("No use for this here!{PAUSE_UNTIL_PRESS}");
