...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_COOLTRAINER] = { _("Ace Wielder"), 12, BALL_ULTRA },
    ...
    [TRAINER_CLASS_BLACK_BELT] = { _("Martial Guy"), 8, BALL_ULTRA },
    [TRAINER_CLASS_ROCK_SMASHER] = { _("Rock"), 1 },
    ...
    [TRAINER_CLASS_DOJO_MASTER] = { _("Dojo Master"), 25, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    ...
    [TRAINER_CLASS_COOLTRAINER_2] = { _("Ace Wielder"), 5, BALL_ULTRA },
