...
{
    static const u8 gText_EarlyMorning[] = _("{DPAD_UPDOWN} EARLY MORNING");
    static const u8 gText_Morning[] = _("{DPAD_UPDOWN} MORNING");
    static const u8 gText_Lunchtime[] = _("{DPAD_UPDOWN} LUNCHTIME");
    static const u8 gText_Afternoon[] = _("{DPAD_UPDOWN} AFTERNOON");
    static const u8 gText_Evening[] = _("{DPAD_UPDOWN} EVENING");
    static const u8 gText_Night[] = _("{DPAD_UPDOWN} NIGHT");
    static const u8 gText_DeadNight[] = _("{DPAD_UPDOWN} DEAD NIGHT");

    switch (gAreaTimeOfDay)
    {
    case TIME_EARLY_MORNING:
        return gText_EarlyMorning;
    case TIME_MORNING:
        return gText_Morning;
    case TIME_LUNCHTIME:
        return gText_Lunchtime;
    case TIME_AFTERNOON:
        return gText_Afternoon;
    case TIME_EVENING:
        return gText_Evening;
    case TIME_NIGHT:
        return gText_Night;
    case TIME_DEAD_NIGHT:
        return gText_DeadNight;
    default:
        return gText_Afternoon;
    }
}
