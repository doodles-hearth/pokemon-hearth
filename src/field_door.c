...
static const u8 sDoorAnimTiles_SlidingLeft[] = INCGFX_U8("graphics/door_anims/indoor_sliding_left.png", ".4bpp");
static const u8 sDoorAnimTiles_SlidingRight[] = INCGFX_U8("graphics/door_anims/indoor_sliding_right.png", ".4bpp");
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
	...
	},
    {
		...
		.sound=DOOR_SOUND_NORMAL,
		.size = DOOR_SIZE_1x1,
		.tiles = sDoorAnimTiles_AbandonedShip,
