...
static void PrintNotEggInfo(void)
{
    ...
    if (BXPY_SummaryScreen_HideSpecies(sMonSummaryScreen->mode))
        ...
        PrintTextOnWindowToFitPx(PSS_LABEL_WINDOW_PORTRAIT_SPECIES, GetSpeciesName(GET_BASE_SPECIES_ID(summary->species2), SKIP_NAME_CHECK), 6, 1, 0, 1, WindowWidthPx(PSS_LABEL_WINDOW_PORTRAIT_SPECIES) - 9);
    else
