...
const u16 gPinkLeavesWeatherPalette[] = INCGFX_U16("graphics/weather/pink_leaves.png", ".gbapal");
const u16 gAutumnLeavesWeatherPalette[] = INCGFX_U16("graphics/weather/autumn_leaves.png", ".gbapal");
const u16 gDecayWeatherPalette[] = INCGFX_U16("graphics/weather/decay.png", ".gbapal");
...
const u8 gWeatherLeafTiles[] = INCGFX_U8("graphics/weather/pink_leaves.png", ".4bpp");
const u8 gWeatherDecayTiles[] = INCGFX_U8("graphics/weather/decay.png", ".4bpp");
...
static u8 TranslateWeatherNum(u8 weather)
{
    ...
    case WEATHER_AUTUMN_LEAVES:      return WEATHER_AUTUMN_LEAVES;
