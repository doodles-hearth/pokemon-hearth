...
void TryPutPokemonTodayOnAir(void)
{
    ...
    else
    {
        ...
        if (!rbernoulli(1, 1) && StringCompare(GetSpeciesName(gBattleResults.caughtMonSpecies, SKIP_NAME_CHECK), gBattleResults.caughtMonNick))
        {
...
static void InterviewBefore_FanClubLetter(void)
{
    ...
    {
        StringCopy(gStringVar1, GetSpeciesName(GetMonData(&gParties[B_TRAINER_PLAYER][GetLeadMonIndex()], MON_DATA_SPECIES), SKIP_NAME_CHECK));
...
static bool8 IsPartyMonNicknamedOrNotEnglish(u8 monIdx)
{
    ...
    if (language == GAME_LANGUAGE && !StringCompare(GetSpeciesName(GetMonData(pokemon, MON_DATA_SPECIES), SKIP_NAME_CHECK), gStringVar1))
        return FALSE;
...
static enum Species GetRandomDifferentSpeciesAndNameSeenByPlayer(u8 varIdx, enum Species excludedSpecies)
{
    ...
    StringCopy(gTVStringVarPtrs[varIdx], GetSpeciesName(species, SKIP_NAME_CHECK));
    return species;
}
...
static void GetNicknameSubstring(u8 varIdx, u8 whichPosition, u8 charParam, u16 whichString, enum Species species, TVShow *show)
{
    ...
    {
        strlen = StringLength(GetSpeciesName(species, SKIP_NAME_CHECK));
        if (charParam == 0)
        {
            buff[0] = GetSpeciesName(species, SKIP_NAME_CHECK)[whichPosition];
        }
        else if (charParam == 1)
        {
            buff[0] = GetSpeciesName(species, SKIP_NAME_CHECK)[strlen - whichPosition];
        }
        else if (charParam == 2)
        {
            buff[0] = GetSpeciesName(species, SKIP_NAME_CHECK)[whichPosition];
            buff[1] = GetSpeciesName(species, SKIP_NAME_CHECK)[whichPosition + 1];
        }
        else
        {
            buff[0] = GetSpeciesName(species, SKIP_NAME_CHECK)[strlen - (whichPosition + 2)];
            buff[1] = GetSpeciesName(species, SKIP_NAME_CHECK)[strlen - (whichPosition + 1)];
        }
    }
...
static void DoTVShowBravoTrainerPokemonProfile(void)
{
    ...
    case 0:
        ...
        if (!StringCompare(GetSpeciesName(show->bravoTrainer.species, SKIP_NAME_CHECK), show->bravoTrainer.pokemonNickname))
            sTVShowState = 8;
        else
            sTVShowState = 1;
        break;
    case 1:
        StringCopy(gStringVar1, GetSpeciesName(show->bravoTrainer.species, SKIP_NAME_CHECK));
    ...
    case 7:
        TVShowConvertInternationalString(gStringVar1, show->bravoTrainer.playerName, show->bravoTrainer.language);
        StringCopy(gStringVar2, GetSpeciesName(show->bravoTrainer.species, SKIP_NAME_CHECK));
        TVShowDone();
        break;
    case 8:
        StringCopy(gStringVar1, GetSpeciesName(show->bravoTrainer.species, SKIP_NAME_CHECK));
...
static void DoTVShowBravoTrainerBattleTower(void)
{
    ...
    case BRAVOTOWER_STATE_INTRO:
        ...
        StringCopy(gStringVar2, GetSpeciesName(show->bravoTrainerTower.species, SKIP_NAME_CHECK));
    ...
    case BRAVOTOWER_STATE_WON:
        TVShowConvertInternationalString(gStringVar1, show->bravoTrainerTower.opponentName, show->bravoTrainerTower.opponentLanguage);
        StringCopy(gStringVar2, GetSpeciesName(show->bravoTrainerTower.defeatedSpecies, SKIP_NAME_CHECK));
        if (show->bravoTrainerTower.interviewResponse == 0)
            sTVShowState = BRAVOTOWER_STATE_SATISFIED;
        else
            sTVShowState = BRAVOTOWER_STATE_UNSATISFIED;
...
static void DoTVShowTheNameRaterShow(void)
{
    ...
    case 0:
        ...
        StringCopy(gStringVar2, GetSpeciesName(show->nameRaterShow.species, SKIP_NAME_CHECK));
    ...
    case 17:
        GetNicknameSubstring(0, 0, 2, 1, 0, show);
        StringCopy(gStringVar2, GetSpeciesName(show->nameRaterShow.randomSpecies, SKIP_NAME_CHECK));
...
static void DoTVShowPokemonTodaySuccessfulCapture(void)
{
    ...
    case 0:
        ...
        StringCopy(gStringVar2, GetSpeciesName(show->pokemonToday.species, SKIP_NAME_CHECK));
    ...
    case 7:
    case 8:
        StringCopy(gStringVar1, GetSpeciesName(show->pokemonToday.species, SKIP_NAME_CHECK));
...
static void DoTVShowPokemonTodayFailedCapture(void)
{
    ...
    case 0:
        ...
        StringCopy(gStringVar2, GetSpeciesName(show->pokemonTodayFailed.species, SKIP_NAME_CHECK));
        sTVShowState = 1;
        break;
    case 1:
        TVShowConvertInternationalString(gStringVar1, show->pokemonTodayFailed.playerName, show->pokemonTodayFailed.language);
        GetMapName(gStringVar2, show->pokemonTodayFailed.location, 0);
        StringCopy(gStringVar3, GetSpeciesName(show->pokemonTodayFailed.species2, SKIP_NAME_CHECK));
...
static void DoTVShowPokemonFanClubLetter(void)
{
    ...
    case 0:
        ...
        StringCopy(gStringVar2, GetSpeciesName(show->fanclubLetter.species, SKIP_NAME_CHECK));
        sTVShowState = 50;
        break;
    case 1:
        rval = (Random() % 4) + 1;
...
static void DoTVShowPokemonFanClubOpinions(void)
{
    ...
    case 0:
        ...
        StringCopy(gStringVar2, GetSpeciesName(show->fanclubOpinions.species, SKIP_NAME_CHECK));
...
static void DoTVShowPokemonNewsMassOutbreak(void)
{
    ...
    StringCopy(gStringVar2, GetSpeciesName(show->massOutbreak.species, SKIP_NAME_CHECK));
    TVShowDone();
    StartMassOutbreak();
...
static void DoTVShowPokemonContestLiveUpdates(void)
{
    ...
    case CONTESTLIVE_STATE_INTRO:
        ...
        StringCopy(gStringVar2, GetSpeciesName(show->contestLiveUpdates.winningSpecies, SKIP_NAME_CHECK));
    ...
    case CONTESTLIVE_STATE_TALK_ABOUT_LOSER:
        StringCopy(gStringVar1, GetSpeciesName(show->contestLiveUpdates.winningSpecies, SKIP_NAME_CHECK));
        ...
        StringCopy(gStringVar3, GetSpeciesName(show->contestLiveUpdates.losingSpecies, SKIP_NAME_CHECK));
    ...
    case CONTESTLIVE_STATE_NO_APPEALS:
        StringCopy(gStringVar1, GetSpeciesName(show->contestLiveUpdates.losingSpecies, SKIP_NAME_CHECK));
    ...
    case CONTESTLIVE_STATE_LAST_BOTH:
        ...
        StringCopy(gStringVar2, GetSpeciesName(show->contestLiveUpdates.losingSpecies, SKIP_NAME_CHECK));
        sTVShowState = CONTESTLIVE_STATE_OUTRO;
        break;
...
static void DoTVShowPokemonBattleUpdate(void)
{
    ...
    case 2:
        TVShowConvertInternationalString(gStringVar1, show->battleUpdate.playerName, show->battleUpdate.language);
        StringCopy(gStringVar2, GetSpeciesName(show->battleUpdate.speciesPlayer, SKIP_NAME_CHECK));
    ...
    case 3:
        ...
        StringCopy(gStringVar2, GetSpeciesName(show->battleUpdate.speciesOpponent, SKIP_NAME_CHECK));
        sTVShowState = 4;
        break;
    case 4:
        TVShowConvertInternationalString(gStringVar1, show->battleUpdate.playerName, show->battleUpdate.language);
    ...
    case 7:
        TVShowConvertInternationalString(gStringVar1, show->battleUpdate.playerName, show->battleUpdate.language);
        TVShowConvertInternationalString(gStringVar2, show->battleUpdate.linkOpponentName, show->battleUpdate.linkOpponentLanguage);
        StringCopy(gStringVar3, GetSpeciesName(show->battleUpdate.speciesOpponent, SKIP_NAME_CHECK));
        TVShowDone();
        break;
    }
...
void DoTVShowInSearchOfTrainers(void)
{
    ...
    case 2:
        ...
        break;
    case 3:
        StringCopy(gStringVar1, GetSpeciesName(gSaveBlock1Ptr->gabbyAndTyData.mon1, SKIP_NAME_CHECK));
        StringCopy(gStringVar2, GetMoveName(gSaveBlock1Ptr->gabbyAndTyData.lastMove));
        StringCopy(gStringVar3, GetSpeciesName(gSaveBlock1Ptr->gabbyAndTyData.mon2, SKIP_NAME_CHECK));
        sTVShowState = 8;
        break;
    case 4:
    case 5:
    ...
    case 8:
        CopyEasyChatWord(gStringVar1, gSaveBlock1Ptr->gabbyAndTyData.quote[0]);
        StringCopy(gStringVar2, GetSpeciesName(gSaveBlock1Ptr->gabbyAndTyData.mon1, SKIP_NAME_CHECK));
        StringCopy(gStringVar3, GetSpeciesName(gSaveBlock1Ptr->gabbyAndTyData.mon2, SKIP_NAME_CHECK));
        gSpecialVar_Result = TRUE;
        sTVShowState = 0;
        TakeGabbyAndTyOffTheAir();
...
static void DoTVShowPokemonAngler(void)
{
    ...
    case 0:
        ...
        StringCopy(gStringVar2, GetSpeciesName(show->pokemonAngler.species, SKIP_NAME_CHECK));
...
static void DoTVShowTheWorldOfMasters(void)
{
    ...
    case 0:
        ...
        break;
    case 1:
        StringCopy(gStringVar1, GetSpeciesName(show->worldOfMasters.species, SKIP_NAME_CHECK));
        sTVShowState = 2;
        break;
    case 2:
        TVShowConvertInternationalString(gStringVar1, show->worldOfMasters.playerName, show->worldOfMasters.language);
        GetMapName(gStringVar2, show->worldOfMasters.location, 0);
        StringCopy(gStringVar3, GetSpeciesName(show->worldOfMasters.caughtPoke, SKIP_NAME_CHECK));
        TVShowDone();
        break;
    }
...
static void DoTVShowBreakingNewsTV(void)
{
    ...
    case 1:
        ...
        StringCopy(gStringVar2, GetSpeciesName(show->breakingNews.lastOpponentSpecies, SKIP_NAME_CHECK));
    ...
    case 2:
        TVShowConvertInternationalString(gStringVar1, show->breakingNews.playerName, show->breakingNews.language);
        StringCopy(gStringVar2, GetSpeciesName(show->breakingNews.lastOpponentSpecies, SKIP_NAME_CHECK));
        StringCopy(gStringVar3, GetSpeciesName(show->breakingNews.poke1Species, SKIP_NAME_CHECK));
        sTVShowState = 3;
        break;
    case 3:
    ...
    case 7:
        ...
        StringCopy(gStringVar2, GetSpeciesName(show->breakingNews.poke1Species, SKIP_NAME_CHECK));
        sTVShowState = 8;
        break;
    case 12:
        TVShowConvertInternationalString(gStringVar1, show->breakingNews.playerName, show->breakingNews.language);
...
static void DoTVShowSecretBaseVisit(void)
{
    ...
    case 12:
        TVShowConvertInternationalString(gStringVar1, show->secretBaseVisit.playerName, show->secretBaseVisit.language);
        StringCopy(gStringVar2, GetSpeciesName(show->secretBaseVisit.species, SKIP_NAME_CHECK));
...
static void DoTVShowThePokemonBattleSeminar(void)
{
    ...
    case 0:
        ...
        StringCopy(gStringVar2, GetSpeciesName(show->battleSeminar.species, SKIP_NAME_CHECK));
        StringCopy(gStringVar3, GetSpeciesName(show->battleSeminar.foeSpecies, SKIP_NAME_CHECK));
        sTVShowState = 1;
        break;
    case 1:
        TVShowConvertInternationalString(gStringVar1, show->battleSeminar.playerName, show->battleSeminar.language);
        StringCopy(gStringVar2, GetSpeciesName(show->battleSeminar.foeSpecies, SKIP_NAME_CHECK));
        StringCopy(gStringVar3, GetMoveName(show->battleSeminar.move));
        sTVShowState = 2;
        break;
    case 2:
        StringCopy(gStringVar1, GetSpeciesName(show->battleSeminar.species, SKIP_NAME_CHECK));
...
static void DoTVShowPokemonNewsBattleFrontier(void)
{
    ...
    case 13:
        ...
        break;
    case 14:
        StringCopy(gStringVar1, GetSpeciesName(show->frontier.species1, SKIP_NAME_CHECK));
        StringCopy(gStringVar2, GetSpeciesName(show->frontier.species2, SKIP_NAME_CHECK));
        StringCopy(gStringVar3, GetSpeciesName(show->frontier.species3, SKIP_NAME_CHECK));
        sTVShowState = 18;
        break;
    case 15:
        StringCopy(gStringVar1, GetSpeciesName(show->frontier.species1, SKIP_NAME_CHECK));
    ...
    case 16:
        ...
        break;
    case 17:
        StringCopy(gStringVar1, GetSpeciesName(show->frontier.species4, SKIP_NAME_CHECK));
        sTVShowState = 18;
        break;
    case 18:
        TVShowConvertInternationalString(gStringVar1, show->frontier.playerName, show->frontier.language);
