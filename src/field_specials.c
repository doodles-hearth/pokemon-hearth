...
void GetPlayerBoyGirlString(void)
{
    if (gSaveBlock2Ptr->playerGender == MALE)
        StringCopy(gStringVar1, gText_Boy);
    else
        StringCopy(gStringVar1, gText_Girl);
}

void GetPlayerGuyGalString(void)
{
    if (gSaveBlock2Ptr->playerGender == MALE)
        StringCopy(gStringVar1, gText_Guy);
    else
        StringCopy(gStringVar1, gText_Gal);
}

void GetPlayerBoyLassString(void)
{
    if (gSaveBlock2Ptr->playerGender == MALE)
        StringCopy(gStringVar1, gText_Boy);
    else
        StringCopy(gStringVar1, gText_Lass);
}
...
void GetPlayerBrotherSisterString(void)
{
    if (gSaveBlock2Ptr->playerGender == MALE)
        StringCopy(gStringVar1, gText_Brother);
    else
        StringCopy(gStringVar1, gText_Sister);
}

void GetPlayerMrMrsString(void)
{
    if (gSaveBlock2Ptr->playerGender == MALE)
...
{
    u8 obj = SpawnSpecialObjectEventParameterized(OBJ_EVENT_GFX_SUNRISE_BOY_1,
                                                  MOVEMENT_TYPE_FACE_DOWN,
                                                  LOCALID_CAMERA,
