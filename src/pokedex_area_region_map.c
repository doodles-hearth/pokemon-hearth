...
void LoadPokedexAreaMapGfx(const struct PokedexAreaMapTemplate *template)
{
    ...
    SetBgAttribute(template->bg, BG_ATTR_PALETTEMODE, 0);
    CpuCopy32(gRegionMapInfos[regionMapType].dexMapPalette, &gPlttBufferUnfaded[BG_PLTT_ID(6)], gRegionMapInfos[regionMapType].dexMapPaletteSize);
