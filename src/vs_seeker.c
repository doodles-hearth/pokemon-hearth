...
static bool32 IsRegularLandTrainer(u8 graphicsId)
{
    ...
    u16 regularTrainersOnLand[] =
    {
        ...
        OBJ_EVENT_GFX_SUNRISE_BOY_1,
        OBJ_EVENT_GFX_SUNRISE_BOY_2,
        OBJ_EVENT_GFX_SUNRISE_BOY_2,
        ...
        OBJ_EVENT_GFX_SUNRISE_GIRL_1,
        OBJ_EVENT_GFX_SUNRISE_GIRL_2,
        OBJ_EVENT_GFX_SUNRISE_GIRL_2,
        OBJ_EVENT_GFX_HEX_MANIAC,
        OBJ_EVENT_GFX_HIKER,
        OBJ_EVENT_GFX_LASS,
        OBJ_EVENT_GFX_SUNRISE_LITTLE_BOY,
        OBJ_EVENT_GFX_SUNRISE_LITTLE_GIRL,
        OBJ_EVENT_GFX_MAGMA_MEMBER_F,
        OBJ_EVENT_GFX_MAGMA_MEMBER_M,
        OBJ_EVENT_GFX_SUNRISE_MAN_1,
        OBJ_EVENT_GFX_SUNRISE_MAN_2,
        OBJ_EVENT_GFX_SUNRISE_MAN_2,
        ...
        OBJ_EVENT_GFX_TWIN_F,
        OBJ_EVENT_GFX_GARDENER,
