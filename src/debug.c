...
static u32 Debug_GenerateListOutbreakMenu(const struct DebugMenuOption *items)
{
    ...
    for (u32 i = 0; i < (ARRAY_COUNT(sDebugMenu_Actions_MassOutbreak) - 1); i++)
    {
        ...
        case 0:
            ...
            break;
        case 2:
            StringCopy(gStringVar1, GetSpeciesName(gSaveBlock1Ptr->outbreakPokemonSpecies, SKIP_NAME_CHECK));
            break;
        case 3:
...
static const u16 sLocationFlags[] =
{
    ...
    FLAG_VISITED_MAGURO_HARBOR,
    FLAG_VISITED_SILVERIDGE,
    FLAG_VISITED_WINDYCAPE,
    FLAG_VISITED_YIFU_CITY,
    FLAG_VISITED_SOULKEEP,
    FLAG_VISITED_HAVENISLE,
    FLAG_VISITED_MIDDLEISLE,
    FLAG_VISITED_TOPISLE,
    FLAG_VISITED_COREEF_ISLE,
    FLAG_VISITED_DRYUGON,
    FLAG_VISITED_SABERSIDE_TOWN,
    FLAG_VISITED_HANABI_CITY,
    FLAG_VISITED_LEAGUE,
...
static void DebugSelectionStep_UpdateSpecies(u8 taskId, u8 digits, u32 min, u32 max)
{
    ...
    u8 *end = StringCopy(gStringVar2, GetSpeciesName(species, SKIP_NAME_CHECK));
    WrapFontIdToFit(gStringVar2, end, DEBUG_MENU_FONT, WindowWidthPx(gTasks[taskId].tSubWindowId));
    StringCopy(gStringVar3, COMPOUND_STRING(""));
...
static void DebugSelectionStep_UpdateItem(u8 taskId, u8 digits, u32 min, u32 max)
{
    ...
    if (CheckIfItemIsTMHMOrEvolutionStone(itemId) == ITEM_IS_TM_HM)
    {
