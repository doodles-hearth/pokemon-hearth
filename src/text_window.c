...
static const u8 sTextWindowFrame_Hearth1_Gfx[] = INCGFX_U8("graphics/text_window/hearth_1.png", ".4bpp");
...
static const struct TilesPal sWindowFrames[WINDOW_FRAMES_COUNT] =
{
    ...
    {sTextWindowFrame_Hearth1_Gfx, gMessageBox_Pal}
};
...
void LoadMessageBoxGfx(u8 windowId, u16 destOffset, u8 palOffset)
{
    u32 tilemapWidth = 14;
    u32 tilemapHeight = 3;
    u32 tilemapNbPixels = tilemapWidth * tilemapHeight * 8 * 8;
