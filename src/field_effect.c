...
static const u32 sUnusedBirchBeauty[] = INCGFX_U32("graphics/birch_speech/unused_beauty.png", ".4bpp");
...
static const u16 sPokeballGlow_Pal[16] = INCGFX_U16("graphics/field_effects/pics/pokeball_glow.png", ".gbapal");
