...
{
    [MAPSEC_PUDDLE_PATH] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SABERSIDE_QUARRY] = MAPPOPUP_THEME_STONE,
    [MAPSEC_FISHERMANS_CHANNEL_WINDYCAPE] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_FISHERMANS_CHANNEL_MAGURO] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_FISHERMANS_CHANNEL_BOTTOM] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_FISHERMANS_CHANNEL_SACRED] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_FISHERMANS_SHRINE] = MAPPOPUP_THEME_UNDERWATER,
    ...
    [MAPSEC_WINDSWEPT_ROUTE] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_SEATURF_ROUTE] = MAPPOPUP_THEME_UNDERWATER,
    ...
    [MAPSEC_BURNFOOT_PASS_BOTTOM] = MAPPOPUP_THEME_STONE,
    [MAPSEC_STEEPSTONE_PASS_BOTTOM] = MAPPOPUP_THEME_STONE,
    [MAPSEC_BURNFOOT_PASS] = MAPPOPUP_THEME_STONE,
    [MAPSEC_MT_KAZAN_EXTERIOR] = MAPPOPUP_THEME_STONE,
    [MAPSEC_STEEPSTONE_PASS] = MAPPOPUP_THEME_STONE,
    [MAPSEC_SHOGUNATE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_SILVER_TUNNEL] = MAPPOPUP_THEME_STONE2,
    ...
    [MAPSEC_UUME_FOREST] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_SABERSIDE_CHANNEL] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_CROBAT_HIDEOUT] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_SUNRISE_CAVE] = MAPPOPUP_THEME_STONE,
    ...
    [MAPSEC_SILVERIDGE] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_WINDYCAPE] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_YIFU_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_SOULKEEP] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_HAVENISLE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MIDDLEISLE] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_TOPISLE] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_DRYUGON] = MAPPOPUP_THEME_STONE,
    [MAPSEC_SABERSIDE_TOWN] = MAPPOPUP_THEME_STONE,
    [MAPSEC_HANABI_CITY] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_LEAGUE] = MAPPOPUP_THEME_MARBLE,
};
