...
} static  const sRibbonData[] =
{
    ...
    {1, 1, TRAVELLER_RIBBON,     TRUE},
    {1, 1, HISTORIC_RIBBON,      TRUE},
...
} static const sRibbonGfxData[] =
{
    ...
    [TRAVELLER_RIBBON]     = { RIBBONGFX_GIFT_1,         TO_PAL_OFFSET(PALTAG_RIBBON_ICONS_4)},
    [HISTORIC_RIBBON]      = { RIBBONGFX_GIFT_1,         TO_PAL_OFFSET(PALTAG_RIBBON_ICONS_5)},
