...
{
    [OPTION_WITHDRAW]   = {COMPOUND_STRING("Retrieve Pokémon"), COMPOUND_STRING("Call Pokémon from the pasture to\nyour party.")},
    [OPTION_DEPOSIT]    = {COMPOUND_STRING("Send Pokémon"),  COMPOUND_STRING("Send Pokémon from your party to\nthe pasture.")},
    [OPTION_MOVE_MONS]  = {COMPOUND_STRING("Move Pokémon"),     COMPOUND_STRING("Organize the Pokémon in their pens\nand in your party.")},
    [OPTION_MOVE_ITEMS] = {COMPOUND_STRING("Move items"),       COMPOUND_STRING("Move items held by any Pokémon in\na pen or your party.")},
    [OPTION_EXIT]       = {COMPOUND_STRING("I'm done!"),          COMPOUND_STRING("Return to field.")}
};
...
{
    [MSG_EXIT_BOX]             = {COMPOUND_STRING("Leave the pasture?"),         MSG_VAR_NONE},
    [MSG_WHAT_YOU_DO]          = {COMPOUND_STRING("What do you want to do?"),    MSG_VAR_NONE},
    [MSG_PICK_A_THEME]         = {COMPOUND_STRING("Please pick a habitat."),       MSG_VAR_NONE},
    [MSG_PICK_A_WALLPAPER]     = {COMPOUND_STRING("Pick the habitat."),          MSG_VAR_NONE},
    [MSG_IS_SELECTED]          = {gText_PkmnIsSelected,                          MSG_VAR_MON_NAME_1},
    [MSG_JUMP_TO_WHICH_BOX]    = {COMPOUND_STRING("Jump to which pen?"),         MSG_VAR_NONE},
    [MSG_DEPOSIT_IN_WHICH_BOX] = {COMPOUND_STRING("Send to which pen?"),      MSG_VAR_NONE},
    [MSG_WAS_DEPOSITED]        = {COMPOUND_STRING("{DYNAMIC 0} sent to pasture."), MSG_VAR_MON_NAME_1},
    [MSG_BOX_IS_FULL]          = {COMPOUND_STRING("The pen is full!"),           MSG_VAR_NONE},
    ...
    [MSG_CONTINUE_BOX]         = {COMPOUND_STRING("Continue operations?"),   MSG_VAR_NONE},
...
static void SetDisplayMonData(void *pokemon, u8 mode)
{
    ...
    if (mode == MODE_PARTY)
    {
        ...
        if (sStorage->displayMonSpecies != SPECIES_NONE)
        {
            ...
            sStorage->displayMonColoration = GetMonData(mon, MON_DATA_COLORATION);
    ...
    else
    {
        ...
        *(txtPtr++) = CHAR_SLASH;
        StringCopyPadded(txtPtr, GetSpeciesName(sStorage->displayMonSpecies, TRUE), CHAR_SPACE, 5);
...
static const u8 *const sMenuTexts[] =
{
    ...
    [MENU_STORE]      = COMPOUND_STRING("Send"),
    [MENU_WITHDRAW]   = COMPOUND_STRING("Retrieve"),
    ...
    [MENU_WALLPAPER]  = COMPOUND_STRING("Habitat"),
