...
static void ItemPrintFunc_PossibleGroupMembers(u8, u32, u8, u8);
static void ListMenuItemPrintFunc_UnionRoomGroups(u8, u32, u8, u8);
static void TradeBoardListMenuItemPrintFunc(u8, u32, u8, u8);
static void ItemPrintFunc_EmptyList(u8, u32, u8, u8);
...
static void ItemPrintFunc_PossibleGroupMembers(u8 windowId, u32 id, u8 y, u8 itemPos)
{
    struct WirelessLink_Leader *data = sWirelessLinkMain.leader;
...
static void ListMenuItemPrintFunc_UnionRoomGroups(u8 windowId, u32 id, u8 y, u8 itemPos)
{
    struct WirelessLink_Group *data = sWirelessLinkMain.group;
...
static void Task_RunUnionRoom(u8 taskId)
{
    ...
    case UR_STATE_INTERACT_WITH_ATTENDANT:
        ...
        else
        {
            ...
            {
                StringCopy(gStringVar1, GetSpeciesName(GetHostRfuGameData()->tradeSpecies, SKIP_NAME_CHECK));
...
static void ItemPrintFunc_EmptyList(u8 windowId, u32 itemId, u8 y, u8 itemPos)
{
}
...
static void TradeBoardPrintItemInfo(u8 windowId, u8 y, struct RfuGameData * data, const u8 *playerName, u8 colorIdx)
{
    ...
    else
    {
        ...
        PrintUnionRoomText(windowId, FONT_NORMAL, GetSpeciesName(species, SKIP_NAME_CHECK), 118, y, colorIdx);
...
static void TradeBoardListMenuItemPrintFunc(u8 windowId, u32 itemId, u8 y, u8 itemPos)
{
...
static s32 GetChatLeaderActionRequestMessage(u8 *dst, u32 gender, u16 *activityData, struct WirelessLink_URoom *uroom)
{
    ...
    case ACTIVITY_TRADE | IN_UNION_ROOM:
        ...
        StringCopy(uroom->activityRequestStrbufs[1], GetSpeciesName(sUnionRoomTrade.playerSpecies, SKIP_NAME_CHECK));
        for (i = 0; i < RFU_CHILD_MAX; i++)
        {
            if (gRfuLinkStatus->partner[i].serialNo == RFU_SERIAL_GAME)
            {
                ...
                StringCopy(uroom->activityRequestStrbufs[3], GetSpeciesName(activityData[1], SKIP_NAME_CHECK));
