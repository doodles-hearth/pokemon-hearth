...
extern const u32 gBattleTerrainPalette_GinkoWoods[];
...
extern const u32 gItemIconPalette_RevivalPowder[];
...
extern const u32 gItemIconPalette_NormalScroll[];
extern const u32 gItemIconPalette_FireScroll[];
extern const u32 gItemIconPalette_WaterScroll[];
extern const u32 gItemIconPalette_ElectricScroll[];
extern const u32 gItemIconPalette_GrassScroll[];
extern const u32 gItemIconPalette_IceScroll[];
extern const u32 gItemIconPalette_FightingScroll[];
extern const u32 gItemIconPalette_PoisonScroll[];
extern const u32 gItemIconPalette_GroundScroll[];
extern const u32 gItemIconPalette_FlyingScroll[];
extern const u32 gItemIconPalette_PsychicScroll[];
extern const u32 gItemIconPalette_BugScroll[];
extern const u32 gItemIconPalette_RockScroll[];
extern const u32 gItemIconPalette_GhostScroll[];
extern const u32 gItemIconPalette_DragonScroll[];
extern const u32 gItemIconPalette_DarkScroll[];
extern const u32 gItemIconPalette_SteelScroll[];
extern const u32 gItemIconPalette_FairyScroll[];
extern const u32 gItemIcon_SecretScroll[];
extern const u32 gItemIconPalette_SecretScrollCut[];
extern const u32 gItemIconPalette_SecretScrollSmash[];
extern const u32 gItemIconPalette_SecretScrollSurf[];
extern const u32 gItemIconPalette_SecretScrollDive[];
extern const u32 gItemIconPalette_SecretScrollWaterfall[];
extern const u32 gItemIconPalette_SecretScrollStrength[];
extern const u32 gItemIconPalette_SecretScrollFly[];
extern const u32 gItemIconPalette_SecretScrollClimb[];
extern const u32 gItemIconPalette_SecretScrollFlash[];
// Charms
...
extern const u32 gItemIconPalette_AshiisScarf[];
