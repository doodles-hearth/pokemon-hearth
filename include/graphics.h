...
extern const u32 gBallGfx_Kaba[];
extern const u16 gBallPal_Kaba[];
...
extern const u16 gItemIconPalette_MysteryScroll[];
...
extern const u32 gBattleAnimSpriteGfx_DecayParticles[];
extern const u16 gBattleAnimSpritePal_DecayParticles[];
