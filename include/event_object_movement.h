...
u8 GetWalkSlowerMovementAction(u32);
...
void MovementType_WanderAroundSlower(struct Sprite *);
...
u8 MovementType_WanderAround_Step5Slower(struct ObjectEvent *, struct Sprite *);
