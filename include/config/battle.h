...
#define B_TRAINER_EXP_MULTIPLIER    GEN_6 // In Gen7+, Trainer battles no longer increase total experience by 1.5x.
...
#define B_SCALED_EXP                GEN_5 // In Gen5 and Gen7+, experience gain is weighted by the difference between the levels of the player's Pokémon and the target.
...
// Other settings
#define B_MULTI_BATTLE_WHITEOUT         GEN_3 // In Gen4+, Multi Battles end when the player as well as their partner don't have any Pokémon left.
