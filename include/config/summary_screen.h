...
// Settings
#define P_SUMMARY_SCREEN_MOVE_RELEARNER  DISABLED_ON_RELEASE // If TRUE, shows an option for Pokémon to relearn moves on the summary screen moves page.
...
#define P_SUMMARY_SCREEN_RENAME          DISABLED_ON_RELEASE // If TRUE, an option to change Pokémon nicknames replaces the cancel prompt on the summary screen info page.
