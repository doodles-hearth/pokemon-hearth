...
enum {
    ...
    HEAL_LOCATION_SUNRISE_VILLAGE,
    HEAL_LOCATION_CHII_TOWN,
    HEAL_LOCATION_SAKU_TOWN,
    HEAL_LOCATION_KURA_TOWN,
    HEAL_LOCATION_MAGURO_HARBOR,
    HEAL_LOCATION_SILVERIDGE,
    HEAL_LOCATION_WINDY_CAPE2,
    HEAL_LOCATION_YIFU_CITY,
    HEAL_LOCATION_SOULKEEP,
    HEAL_LOCATION_HAVEN_ISLE,
    HEAL_LOCATION_MIDDLE_ISLE,
    HEAL_LOCATION_TOP_ISLE,
    HEAL_LOCATION_COREEF_ISLE,
    HEAL_LOCATION_DRYUGON,
    HEAL_LOCATION_SABERSIDE_TOWN,
    HEAL_LOCATION_HANABI_CITY,
    NUM_HEAL_LOCATIONS
};
