...
#define FLDEFF_SMILEY_FACE_ICON          89
#define FLDEFF_HALL_OF_FAME_RECORD_FRLG  90
#define FLDEFF_PHOTO_FLASH               91
...
#define FLDEFFOBJ_CAVE_FOOTPRINTS       41
#define FLDEFFOBJ_CAVE_TRACKS_SLITHER   42
