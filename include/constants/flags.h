...
#define FLAG_GAVE_LETTER_ELDER_SILVERIDGE 0xA6
#define FLAG_HIDE_KOISHI                     0xA7
...
#define FLAG_HIDDEN_ITEM_WHITESLATE_ROUTE_LEFTOVERS          (FLAG_HIDDEN_ITEMS_START + 0x04)
#define FLAG_HIDDEN_ITEM_KURA_VILLAGE_REVIVAL_HERB           (FLAG_HIDDEN_ITEMS_START + 0x05)
#define FLAG_HIDDEN_ITEM_TRANQUIL_ROUTE_REVIVAL_HERB         (FLAG_HIDDEN_ITEMS_START + 0x06)
#define FLAG_HIDDEN_ITEM_SILVER_TUNNEL_FRESH_WATER           (FLAG_HIDDEN_ITEMS_START + 0x07)
#define FLAG_HIDDEN_ITEM_GRASSFLOWER_PLATEAU_REVIVAL_HERB    (FLAG_HIDDEN_ITEMS_START + 0x08)
...
#define FLAG_HIDDEN_ITEM_BEACHBOUND_ROUTE_ANTIDOTE           (FLAG_HIDDEN_ITEMS_START + 0x3E)
#define FLAG_HIDDEN_ITEM_SILVER_TUNNEL_MOON_STONE            (FLAG_HIDDEN_ITEMS_START + 0x3F)
#define FLAG_HIDDEN_ITEM_SILVER_TUNNEL_HYPER_OINTMENT        (FLAG_HIDDEN_ITEMS_START + 0x40)
#define FLAG_HIDDEN_ITEM_SILVER_TUNNEL_STAR_PIECE            (FLAG_HIDDEN_ITEMS_START + 0x41)
...
#define FLAG_ITEM_BEACHBOUND_ROUTE_ETHER                            0x3EA
#define FLAG_ITEM_HARD_STONE                                        0x3EB
#define FLAG_ITEM_SILVER_TUNNEL_PROTEIN                             0x3EC
...
#define FLAG_ITEM_WINDSWEPT_ROUTE_XXX                               0x422
...
#define FLAG_VISITED_SILVERIDGE                     (SYSTEM_FLAGS + 0x13)
#define FLAG_VISITED_WINDYCAPE                      (SYSTEM_FLAGS + 0x14)
#define FLAG_VISITED_YIFU_CITY                      (SYSTEM_FLAGS + 0x15)
#define FLAG_VISITED_MAGURO_HARBOR                  (SYSTEM_FLAGS + 0x16)
...
#define FLAG_VISITED_DRYUGON                        (SYSTEM_FLAGS + 0x1B)
#define FLAG_VISITED_SABERSIDE_TOWN                 (SYSTEM_FLAGS + 0x1C)
