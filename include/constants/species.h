...
enum __attribute__((packed)) Species
{
    ...
    SPECIES_NIDORAN = SPECIES_NIDORAN_M,
    SPECIES_NIDORINO = 33,
    SPECIES_NIDOKING = 34,
    SPECIES_CLEFAIRY = 35,
    SPECIES_CLEFABLE = 36,
    ...
    // Hearth
    SPECIES_KOTORA = 1573,
    SPECIES_RAITORA = 1574,
    SPECIES_SEWADDLE_TOKUAN = 1575,
    SPECIES_SWADLOON_TOKUAN = 1576,
    SPECIES_LEAVANNY_TOKUAN = 1577,
    SPECIES_PSYDUCK_TOKUAN = 1578,
    SPECIES_GOLDUCK_TOKUAN = 1579,
    SPECIES_HONESTREE = 1580,
    SPECIES_SHADOWL = 1581,
    SPECIES_TOXEL_TOKUAN = 1582,
    SPECIES_TOXIKYU_LOW_KEY = 1583,
    SPECIES_TOXIKYU_AMPED = 1584,
    SPECIES_VENONAT_TOKUAN = 1585,
    SPECIES_VENOMOTH_TOKUAN = 1586,
    SPECIES_MAGIKARP_TOKUAN = 1587,
    SPECIES_GYARADOS_TOKUAN = 1588,

    SPECIES_EGG = (SPECIES_GYARADOS_TOKUAN + 1),
