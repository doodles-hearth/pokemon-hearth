...
#define MUS_SNOW                    562
#define MUS_OFFSET                  563

// These PH_* constants are phoneme sounds used by the "bard" NPC (see src/bard_music.c and src/mauville_old_man.c).
// Each comes in a triplet of PH_*_BLEND, PH_*_HELD, and PH_*_SOLO, and the name of each triplet incorporates the English phonetic sound it represents.
#define PH_TRAP_BLEND               564
#define PH_TRAP_HELD                565
#define PH_TRAP_SOLO                566
#define PH_FACE_BLEND               567
#define PH_FACE_HELD                568
#define PH_FACE_SOLO                569
#define PH_CLOTH_BLEND              570
#define PH_CLOTH_HELD               571
#define PH_CLOTH_SOLO               572
#define PH_DRESS_BLEND              573
#define PH_DRESS_HELD               574
