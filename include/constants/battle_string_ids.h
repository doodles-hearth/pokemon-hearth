...
enum StringID
{
    ...
    STRINGID_FOGISDEEP,
    STRINGID_FOGLIFTED,
    STRINGID_SMOKEFILLSTHEAIR,
    STRINGID_SMOKEDISSIPTED,
    STRINGID_LEAVESFILLTHEAIR,
    STRINGID_LEAVESSCATTERED,
    STRINGID_DECAYSPREADS,
    STRINGID_DECAYWASCLEANSED,
    ...
    STRINGID_SMOKEEXPLOSION,
    STRINGID_SMOKEEXPLOSIONINEFFECTIVE,
...
enum WeatherEndStringID
{
    ...
    B_MSG_WEATHER_END_SMOKE,
    B_MSG_WEATHER_END_LEAVES,
    B_MSG_WEATHER_END_DECAY,
...
enum WeatherTurnStringID
{
    ...
    B_MSG_WEATHER_TURN_SMOKE,
    B_MSG_WEATHER_TURN_LEAVES,
    B_MSG_WEATHER_TURN_DECAY,
...
enum FlashFireStringID
{
    ...
    B_MSG_FLASH_FIRE_NO_BOOST_SMOKE,
};
