...
// Custom hearth items
    ITEM_FISHCAKE             = 874,
    ITEM_REFUGE_ROOM_KEY      = 875,
    ITEM_ENTEI_STATUETTE      = 876,
    ITEM_UUMEGIRI             = 877,
    ITEM_SUPERGIRI            = 878,
    ITEM_HYPERGIRI            = 879,
    ITEM_MAXGIRI              = 880,
    ITEM_SACREDGIRI           = 881,
    ITEM_OINTMENT             = 882,
    ITEM_SUPER_OINTMENT       = 883,
    ITEM_HYPER_OINTMENT       = 884,
    ITEM_MAX_OINTMENT         = 885,
    ITEM_SACRED_OINTMENT      = 886,
    ITEM_SLOWPOKE_TAIL        = 887,
    ITEM_ULTRA_BALL_KNOCKOFF  = 888,
    ITEM_ESCAPE_ROPE_KNOCKOFF = 889,
    ITEM_STOLEN_MONS          = 890,
    ITEM_REVIVAL_POWDER       = 891,
    ITEM_REVIVAL_BALM         = 892,
    ITEM_SECRET_START         = 893,
    ITEM_SECRET_CUT           = ITEM_SECRET_START,
    ITEM_SECRET_SMASH         = 894,
    ITEM_SECRET_STRENGTH      = 895,
    ITEM_SECRET_SURF          = 896,
    ITEM_SECRET_DIVE          = 897,
    ITEM_SECRET_WATERFALL     = 898,
    ITEM_SECRET_FLY           = 899,
    ITEM_SECRET_CLIMB         = 900,
    ITEM_SECRET_FLASH         = 901,
    ITEM_SPECIAL_MEDICINE     = 902,
    ITEM_SHINY_VIAL           = 903,
    ITEM_SABLEYE_GEM          = 904,
    ITEM_RAIKOU_BALM          = 905,
    ITEM_LIGHT_POKE_BALL      = 906,
...
enum EffectItem
{
    EFFECT_ITEM_ENIGMA_BERRY_EREADER = 1,  // Enigma Berry dummy constant
    EFFECT_ITEM_RESTORE_HP = 1,            // Must be non-zero
