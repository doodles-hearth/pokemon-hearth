...
enum
{
    ...
    OBJ_EVENT_GFX_FARMER,
    OBJ_EVENT_GFX_BATTLE_GIRL,
    OBJ_EVENT_GFX_CUTTABLE_TREE_KURA_DOJO,
    OBJ_EVENT_GFX_TRAVELER,
    ...
    OBJ_EVENT_GFX_DRAKE,
    OBJ_EVENT_GFX_KOISHI,
    OBJ_EVENT_GFX_HANA,
    OBJ_EVENT_GFX_YUTAKA,
    ...
    OBJ_EVENT_GFX_SHAMISEN_BLUE,
    OBJ_EVENT_GFX_SHAMISEN_GREEN,
    OBJ_EVENT_GFX_SHAMISEN_RED,
    ...
    OBJ_EVENT_GFX_FIREBRINGER,
    OBJ_EVENT_GFX_TRAVELLING_MERCHANT,
    OBJ_EVENT_GFX_ONSEN_F,
    OBJ_EVENT_GFX_BEAN,
    OBJ_EVENT_GFX_NATSUKI,
    OBJ_EVENT_GFX_CROBAT_SHADOWS_GRUNT_M,
    OBJ_EVENT_GFX_CROBAT_SHADOWS_GRUNT_F,
    OBJ_EVENT_GFX_MONK,
    OBJ_EVENT_GFX_SAMURAI,
    OBJ_EVENT_GFX_ELDER2,
    OBJ_EVENT_GFX_KIMONO_GIRL,
    OBJ_EVENT_GFX_COOLTRAINER,
    OBJ_EVENT_GFX_CROBAT_SHADOWS_BOSS,
    OBJ_EVENT_GFX_CROBAT_SHADOWS_KEVIN,
    OBJ_EVENT_GFX_BREEDER_F,
    OBJ_EVENT_GFX_BREEDER_M,
    OBJ_EVENT_GFX_LIGHT_SPRITE,
    OBJ_EVENT_GFX_SCHOOL_KID_F,
    OBJ_EVENT_GFX_SCHOOL_KID_M_ORANGE_UNUSED,
    OBJ_EVENT_GFX_SCHOOL_KID_F_ORANGE_UNUSED,
    OBJ_EVENT_GFX_MAREEP_DOLL,
    OBJ_EVENT_GFX_LUNCHBOX,
    OBJ_EVENT_GFX_CROBAT_SHADOWS_ADMIN_M,
    OBJ_EVENT_GFX_CROBAT_SHADOWS_ADMIN_F,
    OBJ_EVENT_GFX_INCENSE_SHOP_KEEPER,
    OBJ_EVENT_GFX_MASQUERAIN_WOMAN,
    OBJ_EVENT_GFX_MEDIUM,
    OBJ_EVENT_GFX_GEM_MANIAC,
    OBJ_EVENT_GFX_MINER,
    ...
    OBJ_EVENT_GFX_SUNRISE_OLD_WOMAN,
    OBJ_EVENT_GFX_SUNRISE_OLD_MAN,
    ...
    OBJ_EVENT_GFX_SUNRISE_NURSE,
    OBJ_EVENT_GFX_SUNRISE_VALET,
    OBJ_EVENT_GFX_SUNRISE_FAT_GUY,
    OBJ_EVENT_GFX_UUME_WOMAN_1,
    OBJ_EVENT_GFX_UUME_WOMAN_2,
    OBJ_EVENT_GFX_UUME_MAN_1,
    OBJ_EVENT_GFX_UUME_MAN_2,
    OBJ_EVENT_GFX_UUME_OLD_WOMAN,
    OBJ_EVENT_GFX_UUME_OLD_MAN,
    OBJ_EVENT_GFX_UUME_LITTLE_BOY,
    OBJ_EVENT_GFX_UUME_LITTLE_GIRL,
    OBJ_EVENT_GFX_UUME_GIRL_1,
    OBJ_EVENT_GFX_UUME_GIRL_2,
    OBJ_EVENT_GFX_UUME_BOY_1,
    OBJ_EVENT_GFX_UUME_BOY_2,
    OBJ_EVENT_GFX_UUME_NURSE,
    OBJ_EVENT_GFX_UUME_VALET,
    OBJ_EVENT_GFX_UUME_FAT_GUY,
    OBJ_EVENT_GFX_HOT_WOMAN_1,
    OBJ_EVENT_GFX_HOT_WOMAN_2,
    OBJ_EVENT_GFX_HOT_MAN_1,
    OBJ_EVENT_GFX_HOT_MAN_2,
    OBJ_EVENT_GFX_HOT_OLD_WOMAN,
    OBJ_EVENT_GFX_HOT_OLD_MAN,
    OBJ_EVENT_GFX_HOT_LITTLE_BOY,
    OBJ_EVENT_GFX_HOT_LITTLE_GIRL,
    OBJ_EVENT_GFX_HOT_GIRL_1,
    OBJ_EVENT_GFX_HOT_GIRL_2,
    OBJ_EVENT_GFX_HOT_BOY_1,
    OBJ_EVENT_GFX_HOT_BOY_2,
    OBJ_EVENT_GFX_HOT_NURSE,
    OBJ_EVENT_GFX_HOT_VALET,
    OBJ_EVENT_GFX_HOT_FAT_GUY,
    OBJ_EVENT_GFX_SAKURA_WOMAN_1,
    OBJ_EVENT_GFX_SAKURA_WOMAN_2,
    OBJ_EVENT_GFX_SAKURA_MAN_1,
    OBJ_EVENT_GFX_SAKURA_MAN_2,
    OBJ_EVENT_GFX_SAKURA_OLD_WOMAN,
    OBJ_EVENT_GFX_SAKURA_OLD_MAN,
    OBJ_EVENT_GFX_SAKURA_LITTLE_BOY,
    OBJ_EVENT_GFX_SAKURA_LITTLE_GIRL,
    OBJ_EVENT_GFX_SAKURA_GIRL_1,
    OBJ_EVENT_GFX_SAKURA_GIRL_2,
    OBJ_EVENT_GFX_SAKURA_BOY_1,
    OBJ_EVENT_GFX_SAKURA_BOY_2,
    OBJ_EVENT_GFX_SAKURA_NURSE,
    OBJ_EVENT_GFX_SAKURA_VALET,
    OBJ_EVENT_GFX_SAKURA_FAT_GUY,
    OBJ_EVENT_GFX_SEASIDE_WOMAN_1,
    OBJ_EVENT_GFX_SEASIDE_WOMAN_2,
    OBJ_EVENT_GFX_SEASIDE_MAN_1,
    OBJ_EVENT_GFX_SEASIDE_MAN_2,
    OBJ_EVENT_GFX_SEASIDE_OLD_WOMAN,
    OBJ_EVENT_GFX_SEASIDE_OLD_MAN,
    OBJ_EVENT_GFX_SEASIDE_LITTLE_BOY,
    OBJ_EVENT_GFX_SEASIDE_LITTLE_GIRL,
    OBJ_EVENT_GFX_SEASIDE_GIRL_1,
    OBJ_EVENT_GFX_SEASIDE_GIRL_2,
    OBJ_EVENT_GFX_SEASIDE_BOY_1,
    OBJ_EVENT_GFX_SEASIDE_BOY_2,
    OBJ_EVENT_GFX_SEASIDE_NURSE,
    OBJ_EVENT_GFX_SEASIDE_VALET,
    OBJ_EVENT_GFX_SEASIDE_FAT_GUY,
    OBJ_EVENT_GFX_MOUNTAIN_WOMAN_1,
    OBJ_EVENT_GFX_MOUNTAIN_WOMAN_2,
    OBJ_EVENT_GFX_MOUNTAIN_MAN_1,
    OBJ_EVENT_GFX_MOUNTAIN_MAN_2,
    OBJ_EVENT_GFX_MOUNTAIN_OLD_WOMAN,
    OBJ_EVENT_GFX_MOUNTAIN_OLD_MAN,
    OBJ_EVENT_GFX_MOUNTAIN_LITTLE_BOY,
    OBJ_EVENT_GFX_MOUNTAIN_LITTLE_GIRL,
    OBJ_EVENT_GFX_MOUNTAIN_GIRL_1,
    OBJ_EVENT_GFX_MOUNTAIN_GIRL_2,
    OBJ_EVENT_GFX_MOUNTAIN_BOY_1,
    OBJ_EVENT_GFX_MOUNTAIN_BOY_2,
    OBJ_EVENT_GFX_MOUNTAIN_NURSE,
    OBJ_EVENT_GFX_MOUNTAIN_VALET,
    OBJ_EVENT_GFX_MOUNTAIN_FAT_GUY,
    OBJ_EVENT_GFX_UUME_OLD_WOMAN_SWIMMING,
    OBJ_EVENT_GFX_ONSEN_F_SWIMMING,
    OBJ_EVENT_GFX_ONSEN_M_SWIMMING,
    OBJ_EVENT_GFX_CAMPFIRE,
    OBJ_EVENT_GFX_APRICORN_TREE,
    OBJ_EVENT_GFX_BURGLAR,
    OBJ_EVENT_GFX_MASAMUNE,
    OBJ_EVENT_GFX_MINE_CART,
    OBJ_EVENT_GFX_MAY_MINE_CART,
    OBJ_EVENT_GFX_BRENDAN_MINE_CART,
    OBJ_EVENT_GFX_XIAO_HUO,
    ...
    OBJ_EVENT_GFX_CORSOLA_POLLUTED,
    OBJ_EVENT_GFX_CASTFORM_RAIN_GUY,
    OBJ_EVENT_GFX_CASTFORM_SUN_GIRL,
    NUM_OBJ_EVENT_GFX
};
...
#define OBJ_EVENT_PAL_TAG_TRAVELLING_MERCHANT     0x1146
...
#define OBJ_EVENT_PAL_TAG_TREE_DISGUISE           0x1200
