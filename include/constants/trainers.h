...
enum __attribute__((packed)) TrainerPicID {
    ...
    // Hearth Trainers
    TRAINER_PIC_FRONT_ARTIST,
    TRAINER_PIC_FRONT_FIREBRINGER,
    TRAINER_PIC_FRONT_TRAVELING_MERCHANT,
    TRAINER_PIC_FRONT_ONSEN_F,
    TRAINER_PIC_FRONT_ONSEN_M,
    TRAINER_PIC_FRONT_SHAMISEN,
    TRAINER_PIC_FRONT_BEAN,
    TRAINER_PIC_FRONT_NATSUKI,
    TRAINER_PIC_FRONT_MONK,
    TRAINER_PIC_FRONT_COOK,
    TRAINER_PIC_FRONT_KIMONO_GIRL,
    TRAINER_PIC_FRONT_ZUBAT_GRUNT_M,
    TRAINER_PIC_FRONT_ZUBAT_GRUNT_F,
    TRAINER_PIC_FRONT_CROBAT_BOSS,
    TRAINER_PIC_FRONT_SCHOOL_KID_M_ORANGE,
    TRAINER_PIC_FRONT_SCHOOL_KID_F_ORANGE,
    TRAINER_PIC_FRONT_GARDENER,
    TRAINER_PIC_FRONT_OLD_LADY,
    TRAINER_PIC_FRONT_MINER,
    TRAINER_PIC_FRONT_GOLBAT_ADMIN_M,
    TRAINER_PIC_FRONT_GOLBAT_ADMIN_F,
    TRAINER_PIC_FRONT_MASQUERAIN_WOMAN,
    TRAINER_PIC_FRONT_GEM_MANIAC,
    TRAINER_PIC_FRONT_OLD_MAN,
    TRAINER_PIC_FRONT_SAMURAI,
    TRAINER_PIC_FRONT_BATTLE_GUY,
    TRAINER_PIC_FRONT_BURGLAR,
    TRAINER_PIC_FRONT_FARMER,
    TRAINER_PIC_FRONT_LEADER_MASAMUNE,
    TRAINER_PIC_FRONT_LEADER_KOISHI,
    TRAINER_PIC_FRONT_LEADER_HANA,
    TRAINER_PIC_FRONT_LEADER_YUTAKA,
    TRAINER_PIC_FRONT_DISGUISE_KID,
    TRAINER_PIC_FRONT_COUNT,

    TRAINER_PIC_BACK_BRENDAN = TRAINER_PIC_FRONT_COUNT,  // The player back pics are assumed to alternate according to the gender
...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_ZUBAT,
    TRAINER_CLASS_CROBAT_SHADOW_LEADER,
    TRAINER_CLASS_TRAVELING_MERCHANT,
    TRAINER_CLASS_ONSEN_F,
    TRAINER_CLASS_ONSEN_M,
    TRAINER_CLASS_SHAMISEN,
    TRAINER_CLASS_MONK,
    TRAINER_CLASS_COOK,
    TRAINER_CLASS_KIMONO_GIRL,
    TRAINER_CLASS_MINER,
    TRAINER_CLASS_OLD_LADY,
    ...
    TRAINER_CLASS_SMITH,
    TRAINER_CLASS_DISGUISE_KID,
    TRAINER_CLASS_MESSENGER,
    TRAINER_CLASS_COUNT
};
...
#define TRAINER_MON_UNKNOWN_COLOR  0xFF
