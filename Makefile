...
# TODO EVA OK? previous was TEACHABLE_DEPS := $(ALL_LEARNABLES_JSON) $(shell find data \( -iname '*.inc' -o -iname '*.scr' \)) $(INCLUDE_DIRS)/constants/tms_hms.h $(INCLUDE_DIRS)/config/pokemon.h $(C_SUBDIR)/pokemon.c
